					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Worklist for business partners",
									"targetURL": "#businesspartner-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"businesspartner-display": {
								...
								"action": "display",
								"description": "A Fiori application for business partners",
								"title": "Worklist for business partners",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=businesspartner",
									"url": sap.ui.require.toUrl("businesspartner")
								}
							}
						}
					}
